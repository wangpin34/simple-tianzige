...
<template>
  <div class="p-8 justify-center flex flex-col items-center">
    <div class="relative aspect-square outline-1 outline-slate-300 outline-dashed">
      <img :src="`/graphics-bishun/${charCode}.svg?timestamp=${timestamp}`" class="w-32" />
      <van-icon name="replay" size="24" class="absolute bottom-0 right-0 cursor-pointer" @click="onReplay" />
    </div>
    <div class="mt-4 flex flex-wrap">
      <template v-for="step in graphic.strokes.length">
        <div class="w-24 aspect-square shrink relative outline-1 outline-slate-300 outline-dashed">
